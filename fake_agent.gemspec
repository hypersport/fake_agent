...
Gem::Specification.new do |spec| spec.name = "fake_agent"
spec.version = FakeAgent::VERSION
spec.authors = ["hypersport"]
spec.email = ["boss.yuan@outlook.com"]

spec.summary = "Fake User Agent"
spec.description = "Up-to-date simple useragent faker with real world database."
...
spec.metadata["changelog_uri"] = "https://github.com/hypersport/fake_agent/main/CHANGELOG.md"
